...
def main():
    ...
    try:
        ...
        # Example 2: Position control with torque limit (HLS only)
        if servo_type == "hls":
            ...
            torque_limits = {
                ...
                2: 0.5,    # 50% torque limit
                3: 0.5     # 50% torque limit
            }
            
            results = controller.write_position(target_positions, torque_limits)
